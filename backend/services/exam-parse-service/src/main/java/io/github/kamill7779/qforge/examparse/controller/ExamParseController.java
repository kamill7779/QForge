package io.github.kamill7779.qforge.examparse.controller;
...
import io.github.kamill7779.qforge.examparse.service.ExamParseCommandService;
import io.github.kamill7779.qforge.examparse.service.ExamParseConfirmService;
...
public class ExamParseController {
    ...
    public ResponseEntity<ExamParseQuestion> updateQuestion(
        ...
        commandService.getTask(taskUuid, requestUser);
