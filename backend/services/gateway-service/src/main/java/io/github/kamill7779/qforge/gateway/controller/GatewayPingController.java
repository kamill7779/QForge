...
public class GatewayPingController {
    ...
    public ResponseEntity<Map<String, String>> securedPing(Principal principal) {
        return ResponseEntity.ok(Map.of("message", "secured gateway ok", "username", principal.getName()));
    }
}
