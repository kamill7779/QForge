...
public class ExamCacheService {
    ...
    private static final String QUESTION_TYPE_CACHE_PREFIX = "qforge:question-types:";
    ...
    public List<QuestionTypeResponse> getQuestionTypes(String requestUser, Supplier<List<QuestionTypeResponse>> loader) {
        return getOrLoad(
                QUESTION_TYPE_CACHE_PREFIX + requestUser,
                new TypeReference<List<QuestionTypeResponse>>() {},
                Duration.ofSeconds(cacheProperties.getQuestionTypeTtlSeconds()),
                loader
        );
    }
    ...
    public void evictQuestionTypes(String requestUser) {
        redis.delete(QUESTION_TYPE_CACHE_PREFIX + requestUser);
    }
