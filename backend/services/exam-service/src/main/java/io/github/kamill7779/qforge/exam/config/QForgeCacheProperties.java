...
public class QForgeCacheProperties {
    ...
    private int questionTypeTtlSeconds = 1800;
    private int basketTtlSeconds = 600;

    public int getQuestionTypeTtlSeconds() {
        return questionTypeTtlSeconds;
    }

    public void setQuestionTypeTtlSeconds(int questionTypeTtlSeconds) {
        this.questionTypeTtlSeconds = questionTypeTtlSeconds;
    }
