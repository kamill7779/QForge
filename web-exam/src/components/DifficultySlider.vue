...
watch(() => props.modelValue, (val) => {
  if (val !== null && val !== undefined && val !== diff.pValue.value) diff.setValue(val)
})
...
.slider-input:disabled { opacity: 0.4; }
.slider-value {
  font-weight: 700;
  font-size: 0.88rem;
  min-width: 2.5em;
...
.d-easy { color: #00b894; background: rgba(0,184,148,0.12); }
.d-medium-easy { color: #00cec9; background: rgba(0,206,201,0.12); }
.d-medium { color: #e17055; background: rgba(225,112,85,0.1); }
.d-hard { color: #d63031; background: rgba(214,48,49,0.1); }
.d-very-hard { color: #a29bfe; background: rgba(162,155,254,0.12); }
</style>
